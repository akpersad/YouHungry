    ...
    template: (data: AlertData) => `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="margin-top: 20px; padding: 15px; background: #f3f4f6; border-radius: 8px; font-size: 14px; color: #6b7280;">
          <p style="margin: 0;">This alert was generated by the Fork In The Road Admin Alert System.</p>
  ...
  maintenance_scheduled: {
    ...
    template: (data: AlertData) => `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="margin-top: 20px; padding: 15px; background: #f3f4f6; border-radius: 8px; font-size: 14px; color: #6b7280;">
          <p style="margin: 0;">This maintenance notification was sent by the Fork In The Road Admin Alert System.</p>
  ...
  maintenance_completed: {
    ...
    template: (data: AlertData) => `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="margin-top: 20px; padding: 15px; background: #f3f4f6; border-radius: 8px; font-size: 14px; color: #6b7280;">
          <p style="margin: 0;">This notification was sent by the Fork In The Road Admin Alert System.</p>
          <p style="margin: 5px 0 0 0;">To manage your notification preferences, visit the admin panel.</p>
        </div>
      </div>
    `,
  ...
  async sendTestEmail(recipient: string): Promise<boolean> {
    try {
      ...
      const testAlertData: AlertData = {
        ...
        metadata: {
          'Test Mode': 'Yes',
          System: 'Fork In The Road Admin Panel',
        },
        recommendedActions: [
