...
| --- | ------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------- | ------------------------------------------------ |
| X1  | Every wait feels handled (loading)          | Skeletons now on the dashboard (collections grid + activity feed); single-announce `SkeletonGroup` region; other surfaces still spinner | ⚠️→◧ dashboard done (C7)            | ◧ C7 (dashboard); C9–C12 apply per-surface       |
