...
- Great as the _first_ step — let it pick the palette/typography system, then hand off to
...
- Reach for it on **greenfield landing pages / portfolios** or **redesigns** where the explicit
  goal is to _not_ look like a generic AI template.
...
**What it does:** Applies foundational visual-design principles (based on _Design for Hackers_ by
...
- Use it as a **review/teaching lens** when you want the _reasoning_ behind choices (why this
